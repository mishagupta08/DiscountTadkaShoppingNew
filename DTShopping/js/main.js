(function ($) {
    ...
    function filterSlider() {
        ...
        var selectedMinValue = $('#minPointValue').html();
        var selectedMaxValue = $('#maxPointValue').html();

        if (!(selectedMinValue == "" || selectedMinValue == undefined)) {
            defaultMinValue = parseInt(selectedMinValue);
        }

        if (!(selectedMaxValue == "" || selectedMaxValue == undefined)) {
            defaultMaxValue = parseInt(selectedMaxValue);
        }
